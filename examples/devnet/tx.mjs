...
const main = async () => {
  ...
  const alice = Core.addressFromBech32(
    "addr_test1vztan2tydv3k7pxevnx07pz8xvv4nfecg392vnxtqr77elskq0e8a"
  )

  const provider = new DevnetProvider("ws://localhost:1338") 
  await provider.init()

  const faucet = new ColdWallet("addr_test1vztc80na8320zymhjekl40yjsnxkcvhu58x59mc2fuwvgkc332vxv" , 0, provider)
